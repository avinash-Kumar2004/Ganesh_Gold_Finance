...
const T = {
  ...
  gu: { // Gujarati
    title: "ગોલ્ડ લોન કેલ્ક્યુલેટર",
    subtitle: "તમારી લોન પાત્રતા તરત જાણો",
    name: "પૂરું નામ",
    email: "ઈમેલ આઈડી",
    contact: "સંપર્ક નંબર",
    ...
    silver: "ચાંદી",
    platinum: "પ્લેટિનમ",
    gold_type: "સોનાની શુદ્ધતા",
    weight: "વજન (ગ્રામ)",
    amount_req: "જરૂરી રકમ (₹)",
    generate_otp: "પાત્રતા ચકાસો",
    note: "#નોંધ: આ અંદાજિત મૂલ્ય છે. અંતિમ રકમ શાખા મૂલ્યાંકન પર નિર્ભર છે.",
    pop_greeting: "નમસ્તે",
    pop_total_gold: "તમારી ધાતુની કિંમત",
    pop_required: "તમને જોઈતી રકમ",
    pop_eligible: "પાત્ર લોન રકમ",
    pop_based: "વર્તમાન બજાર ભાવ પર આધારિત",
    pop_ok: "અરજી કરો",
    pop_close: "બંધ કરો",
    pop_congrats: "અભિનંદન!",
    select_gold_type: "શુદ્ધતા પસંદ કરો",
    select_metal: "ધાતુ પસંદ કરો",
    fetching: "લાઇવ ભાવ મેળવી રહ્યા...",
    live_rate: "લાઇવ દર",
    approx: "અંદાજિત",
  },
  te: { // Telugu
    title: "గోల్డ్ లోన్ కాలిక్యులేటర్",
    subtitle: "మీ లోన్ అర్హతను వెంటనే తెలుసుకోండి",
    name: "పూర్తి పేరు",
    email: "ఇమెయిల్ ఐడి",
    ...
    silver: "వెండి",
    platinum: "ప్లాటినం",
    gold_type: "బంగారం స్వచ్ఛత",
    weight: "బరువు (గ్రాములు)",
    amount_req: "అవసరమైన మొత్తం (₹)",
    generate_otp: "అర్హత లెక్కించండి",
    note: "#గమనిక: ఇది అంచనా విలువ. తుది మొత్తం శాఖ మూల్యాంకనంపై ఆధారపడి ఉంటుంది.",
    pop_greeting: "నమస్కారం",
    pop_total_gold: "మీ లోహం విలువ",
    pop_required: "మీకు అవసరమైన మొత్తం",
    pop_eligible: "అర్హత కలిగిన లోన్ మొత్తం",
    pop_based: "ప్రస్తుత మార్కెట్ ధర ఆధారంగా",
    pop_ok: "ఇప్పుడు దరఖాస్తు చేయండి",
    pop_close: "మూసివేయండి",
    pop_congrats: "అభినందనలు!",
    select_gold_type: "స్వచ్ఛత ఎంచుకోండి",
    select_metal: "లోహం ఎంచుకోండి",
    fetching: "ప్రత్యక్ష ధరలను పొందుతోంది...",
    live_rate: "ప్రత్యక్ష ధర",
    approx: "సుమారు",
  },
  ta: { // Tamil
    title: "தங்க கடன் கால்குலேட்டர்",
    subtitle: "உங்கள் கடன் தகுதியை உடனடியாக அறிய",
    name: "முழு பெயர்",
    ...
    gold_type: "தங்க தூய்மை",
    weight: "எடை (கிராம்)",
    amount_req: "தேவையான தொகை (₹)",
    generate_otp: "தகுதி கணக்கிடு",
    note: "#குறிப்பு: இது மதிப்பிடப்பட்ட தொகை. இறுதித் தொகை கிளை மதிப்பீட்டைப் பொறுத்தது.",
    pop_greeting: "வணக்கம்",
    pop_total_gold: "உங்கள் உலோக மதிப்பு",
    pop_required: "உங்களுக்குத் தேவையான தொகை",
    pop_eligible: "தகுதியான கடன் தொகை",
    pop_based: "தற்போதைய சந்தை விலை அடிப்படையில்",
    pop_ok: "இப்போது விண்ணப்பிக்கவும்",
    pop_close: "மூடு",
    pop_congrats: "வாழ்த்துக்கள்!",
    select_gold_type: "தூய்மை தேர்ந்தெடுக்கவும்",
    select_metal: "உலோகம் தேர்ந்தெடுக்கவும்",
    fetching: "நேரடி விலைகள்...",
    live_rate: "நேரடி விலை",
    approx: "தோராயமான",
  },
  kn: { // Kannada
    title: "ಗೋಲ್ಡ್ ಲೋನ್ ಕ್ಯಾಲ್ಕುಲೇಟರ್",
    subtitle: "ನಿಮ್ಮ ಲೋನ್ ಅರ್ಹತೆಯನ್ನು ತಕ್ಷಣ ತಿಳಿಯಿರಿ",
    name: "ಪೂರ್ಣ ಹೆಸರು",
    email: "ಇಮೇಲ್ ಐಡಿ",
    ...
    silver: "ಬೆಳ್ಳಿ",
    platinum: "ಪ್ಲಾಟಿನಂ",
    gold_type: "ಚಿನ್ನದ ಶುದ್ಧತೆ",
    weight: "ತೂಕ (ಗ್ರಾಂ)",
    amount_req: "ಅಗತ್ಯವಿರುವ ಮೊತ್ತ (₹)",
    generate_otp: "ಅರ್ಹತೆ ಲೆಕ್ಕಾಚಾರ ಮಾಡಿ",
    note: "#ಗಮನಿಸಿ: ಇದು ಅಂದಾಜು ಮೊತ್ತ. ಅಂತಿಮ ಮೊತ್ತವು ಶಾಖೆಯ ಮೌಲ್ಯಮಾಪನವನ್ನು ಅವಲಂಬಿಸಿರುತ್ತದೆ.",
    pop_greeting: "ನಮಸ್ಕಾರ",
    pop_total_gold: "ನಿಮ್ಮ ಲೋಹದ ಮೌಲ್ಯ",
    pop_required: "ನಿಮಗೆ ಬೇಕಾದ ಮೊತ್ತ",
    pop_eligible: "ಅರ್ಹವಾದ ಸಾಲದ ಮೊತ್ತ",
    pop_based: "ಪ್ರಸ್ತುತ ಮಾರುಕಟ್ಟೆ ಬೆಲೆ ಆಧಾರದ ಮೇಲೆ",
    pop_ok: "ಈಗ ಅರ್ಜಿ ಸಲ್ಲಿಸಿ",
    pop_close: "ಮುಚ್ಚಿ",
    pop_congrats: "ಅಭಿನಂದನೆಗಳು!",
    select_gold_type: "ಶುದ್ಧತೆ ಆಯ್ಕೆಮಾಡಿ",
    select_metal: "ಲೋಹ ಆಯ್ಕೆಮಾಡಿ",
    fetching: "ಲೈವ್ ಬೆಲೆಗಳು...",
    live_rate: "ಲೈವ್ ದರ",
    approx: "ಅಂದಾಜು",
  },
  as: { // Assamese
    title: "গোল্ড লোন কেলকুলেটৰ",
    subtitle: "আপোনাৰ লোন যোগ্যতা তৎক্ষণাৎ জানক",
    name: "পূৰ্ণ নাম",
    email: "ইমেইল আইডি",
    contact: "যোগাযোগ নম্বৰ",
    select_state: "ৰাজ্য নিৰ্বাচন কৰক",
    pincode: "পিন ক’ড",
    metal: "ধাতুৰ প্ৰকাৰ",
    gold: "সোণ",
    silver: "ৰূপ",
    platinum: "প্লেটিনাম",
    gold_type: "সোণৰ শুদ্ধতা",
    weight: "ওজন (গ্ৰাম)",
    amount_req: "প্ৰয়োজনীয় ধন (₹)",
    generate_otp: "যোগ্যতা গণনা কৰক",
    note: "#টোকা: এইটো এটা আনুমানিক মূল্য। চূড়ান্ত ধন শাখাৰ মূল্যায়নৰ ওপৰত নিৰ্ভৰ কৰে।",
    pop_greeting: "নমস্কাৰ",
    pop_total_gold: "আপোনাৰ ধাতুৰ মূল্য",
    pop_required: "আপোনাৰ প্ৰয়োজনীয় ধন",
    pop_eligible: "যোগ্য লোনৰ ধন",
    pop_based: "বৰ্তমান বজাৰ মূল্যৰ ওপৰত ভিত্তি কৰি",
    pop_ok: "এতিয়া আবেদন কৰক",
    pop_close: "বন্ধ কৰক",
    pop_congrats: "অভিনন্দন!",
    select_gold_type: "শুদ্ধতা নিৰ্বাচন কৰক",
    select_metal: "ধাতু নিৰ্বাচন কৰক",
    fetching: "লাইভ মূল্য...",
    live_rate: "লাইভ দৰ",
    approx: "আনুমানিক",
  },
  ur: { // Urdu
    title: "گولڈ لون کیلکولیٹر",
    subtitle: "اپنی قرض اہلیت فوری جانیں",
    name: "پورا نام",
    email: "ای میل آئی ڈی",
    contact: "رابطہ نمبر",
    ...
    silver: "چاندی",
    platinum: "پلاٹینم",
    gold_type: "سونے کی پاکیزگی",
    weight: "وزن (گرام)",
    amount_req: "مطلوبہ رقم (₹)",
    generate_otp: "اہلیت کا حساب لگائیں",
    note: "#نوٹ: یہ تخمینہ شدہ قیمت ہے۔ حتمی رقم شاخ کی تشخیص پر منحصر ہے۔",
    pop_greeting: "السلام علیکم",
    pop_total_gold: "آپ کی دھات کی قیمت",
    pop_required: "آپ کو مطلوبہ رقم",
    pop_eligible: "اہل قرض کی رقم",
    pop_based: "موجودہ بازار قیمت کی بنیاد پر",
    pop_ok: "ابھی درخواست دیں",
    pop_close: "بند کریں",
    pop_congrats: "مبارک ہو!",
    select_gold_type: "پاکیزگی منتخب کریں",
    select_metal: "دھات منتخب کریں",
    fetching: "لائیو قیمتیں...",
    live_rate: "لائیو ریٹ",
    approx: "تخمینہ",
  },
};
